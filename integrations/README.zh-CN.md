...
[1.0.0 候选服务验证与升级边界](../conformance/release-1.0.zh-CN.md)：按协议／能力／服务模型组合记录真实验证，与下游业务验收分开；不强制原厂模型凭据。

[升级说明](../docs/migrations/1.0.zh-CN.md)。适配器安装不证明真实服务支持；应分别验证实际协议、能力与服务／模型组合。
