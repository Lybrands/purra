# 1.0 development handoff

English | [简体中文](runtime-extension-acceptance.zh-CN.md)

1.0.0 is unreleased. Install matching Core, SQLite and MCP artifacts; publishing,
...
## Expanded 1.0 completion boundary

The additional storage and recovery work assigned to 1.0 is complete inside the
...
- The supported data upgrade is the explicit same-SDK v4-to-v5 offline path. It
  ...
  historical formats and active-Run cross-version continuation are not public 1.0
  contracts.
