# Durable approval contract (1.0 development)
...
in-memory approvals remain supported. See the [1.0 handoff](runtime-extension-acceptance.md)
...
Child write approval is unsupported. Real Provider evidence is limited to the [recorded combination](runtime-extension-acceptance.md#verified-real-provider-combination);
business MCP and downstream validation remain unpassed. This is not a 1.0 release acceptance claim.
