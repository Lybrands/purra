...
for the opt-in 1.1 approval and receipt APIs.
...
mutating storage. See the [1.1 approval inspection contract](conformance/durable-approval.md#read-only-approval-inspection-implemented).
