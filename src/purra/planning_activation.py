...
AUTO_PLANNING_TOOL_SCHEMA = ToolSchema(
    ...
    description=(
        ...
        "Use when the task needs a governed plan under the host's planning "
        "preferences or must be validated for authority, budget, approval, "
        "or durable execution. Do not use for direct answers or ordinary "
        "read-only tool use that does not need planning."
    ),
    parameters={
        "type": "object",
        "properties": {},
