...
RECORDS = {
    ...
    "ModelProtocolCapabilities": (ModelProtocolCapabilities, ('reasoning_control', 'reasoning_replay', 'tool_calling', 'required_tool_choice', 'parallel_tool_calls', 'streaming', 'cancellation', 'public_progress', 'assistant_content_with_tool_calls', 'json_schema_level', 'stream_finish_semantics', 'usage_semantics', 'image_input')),
    ...
    "RuntimeLimits": (RuntimeLimits, ('max_run_generation_tokens', 'max_model_rounds', 'max_progress_rounds', 'max_identical_tool_batches', 'provider_activity_idle_timeout_ms', 'provider_progress_idle_timeout_ms', 'provider_invocation_timeout_ms', 'root_run_timeout_ms', 'max_model_invocation_attempts', 'max_input_tokens', 'max_reasoning_tokens', 'max_provider_output_events', 'max_provider_output_bytes', 'max_stream_content_chars', 'max_stream_reasoning_chars', 'max_stream_chunks')),
